...
function ToggleGroup({
  ...
  return <ToggleGroupPrimitive.Root data-slot="toggle-group" data-variant={variant} data-size={size} className={cn("toggle-group-class-1", className)} {...props}>
...
function ToggleGroupItem({
  ...
  }), "toggle-group-class-2", className)} {...props}>
      {children}
