...
const ToastViewport = React.forwardRef(({
  className,
  ...props
}, ref) => <ToastPrimitives.Viewport ref={ref} className={cn("toast-class-1", className)} {...props} />);
...
const ToastAction = React.forwardRef(({
  className,
  ...props
}, ref) => <ToastPrimitives.Action ref={ref} className={cn("toast-class-2", className)} {...props} />);
ToastAction.displayName = ToastPrimitives.Action.displayName;
const ToastClose = React.forwardRef(({
  className,
  ...props
}, ref) => <ToastPrimitives.Close ref={ref} className={cn("toast-class-3", className)} toast-close="" {...props}>
    <X className={"toast-class-4"} />
  </ToastPrimitives.Close>);
ToastClose.displayName = ToastPrimitives.Close.displayName;
const ToastTitle = React.forwardRef(({
  className,
  ...props
}, ref) => <ToastPrimitives.Title ref={ref} className={cn("toast-class-5", className)} {...props} />);
ToastTitle.displayName = ToastPrimitives.Title.displayName;
const ToastDescription = React.forwardRef(({
  className,
  ...props
}, ref) => <ToastPrimitives.Description ref={ref} className={cn("toast-class-6", className)} {...props} />);
